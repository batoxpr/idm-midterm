    ...
    switch(participants) {
        case 1:
            ...
            <div className={styles.numberImg}>
                <img src="https://i.pinimg.com/originals/a0/ac/f5/a0acf5ab2cd619deab46210077ed165c.gif"></img>
                </div>
                 </div></>;
        case 2:
        case 3:
        ...
        case 6:
            ...
            <div className={styles.numberImg}><img src="https://i.pinimg.com/originals/1a/6f/29/1a6f29751719f398634d5e58d5dd2430.gif"></img>
            </div>
              </div></>;
        default:
            return "Have fun!" ;
